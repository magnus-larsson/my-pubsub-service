...
/**
 * Local HTTP server for tests that require one. Based on the <code>ElementalHttpServer</code> example in HttpCore.
 * 
 * 
 * 
...
public class LocalTestServer {
    ...
    /**
     * The HTTP processor. If the interceptors are thread safe and the list is not modified during operation, the
     ...
     * 
     * @param proc
     *            the HTTP processors to be used by the server, or <code>null</code> to use a {@link #newProcessor
     *            default} processor
     * @param reuseStrat
     *            the connection reuse strategy to be used by the server, or <code>null</code> to use
     *            {@link #newConnectionReuseStrategy() default} strategy.
     * @param params
     *            the parameters to be used by the server, or <code>null</code> to use {@link #newDefaultParams
     *            default} parameters
     * @param sslcontext
     *            optional SSL context if the server is to leverage SSL/TLS transport security
     */
    public LocalTestServer(BasicHttpProcessor proc, ConnectionReuseStrategy reuseStrat, HttpParams params,
    ...
    public class RequestListener implements Runnable {
        ...
        protected void accept() throws IOException {
            ...
            HttpService httpService = new HttpService(httpProcessor, reuseStrategy,
