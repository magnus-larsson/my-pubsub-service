...
public class AtomParserTest {
    ...
    public void parse() throws Exception {
        ...
        Feed feed = parser.parse(UnitTestConstants.TOPIC, UnitTestConstants.ATOM1);
        ...
        Assert.assertEquals(2, feed.getCustom().size());
        
        Assert.assertEquals(Feed.NS_ATOM, feed.getCustom().get(0).getNamespaceURI());
        Assert.assertEquals("title", feed.getCustom().get(0).getLocalName());
        Assert.assertEquals("foobar", feed.getCustom().get(0).getValue());
