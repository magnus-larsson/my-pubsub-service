...
public class Rss2ParserTest {
    ...
    public void parse() throws Exception {
        ...
        Feed feed = parser.parse(UnitTestConstants.TOPIC, UnitTestConstants.RSS1);
        ...
        Assert.assertEquals(1, feed.getCustom().size());
        
        Assert.assertEquals("", feed.getCustom().get(0).getNamespaceURI());
