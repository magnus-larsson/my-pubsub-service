...
public interface AdminService {
    ...
    void createPushSubscriber(URI topic, URI callback, String jmsLoggAddress, int leaseSeconds, String verifyToken, String secret, boolean active) throws IOException, FailedSubscriberVerificationException;

    PushSubscriber getPushSubscriber(UUID id);

    void updatePushSubscriber(UUID id, URI topic, URI callback, String jmsLoggAddress, int leaseSeconds, String verifyToken, String secret, boolean active) throws IOException, FailedSubscriberVerificationException;
